...
// 	bool* indexTf = new bool[stringLen];

// 	for (int i = 0; i < stringLen; i++) {
// 		for (int j = 0; j < 39; j++) {
// 			if (*(s.getString() + i) == c[j]) {
// 				indexTf[i] = 1;
// 				break;
// 			}
// 			else {
...
// String lv3(String s) { //한줄 축약코드 ㄱㄴ하다고함?..
// 	bool tf = s.Contains("..");
// 	while(tf == 1){
// 		s = s.Replace("..",".");
// 		tf = s.Contains("..");
...
// String lv6(String s){ // e까지 나와야함
// 	if(s.getStringLen() > 15){
// 		s = s.Remove(15,s.getStringLen()-15);
// 	}
// 	s = s.Trim('.');
// 	return s;
// }
...
// 	int stringLen = s.getStringLen();
// 	if(stringLen >0){
// 		char c = *(s.getString() + stringLen - 1);
// 		if(stringLen <= 2){
// 			while(stringLen < 3){
// 				s = s.Insert(c, stringLen-1);
// 				stringLen = s.getStringLen();
// 			}
// 		}
// 	}
// 	return s;
...
String solution(String s){
	...
	if(s.getStringLen() == 0){			//lv5
		s = "a";
	}
	
	
	if(s.getStringLen() > 15){			//lv6
		s = s.Remove(15,s.getStringLen()-15);
	}
	s = s.Trim('.');
	...
	if(stringLen >0){					//lv7
		char c2 = *(s.getString() + stringLen - 1);
		if(stringLen <= 2){
			while(stringLen < 3){
				s = s.Insert(c2, stringLen-1);
				stringLen = s.getStringLen();
			}
		}
	}
...
int main(void) {
	...
	String new_id1 = "./././././ab)c{d]/././././.";
	new_id1 = solution(new_id1);
	new_id1.print();
	
	// String new_id2 = "z-+.^.";
	// new_id2 = solution(new_id2);
	// new_id2.print();
	
	// String new_id3 = "=.=";
	// new_id3 = solution(new_id3);
	// new_id3.print();
	
	// String new_id4 = "123_.def";
	// new_id4 = solution(new_id4);
	// new_id4.print();
	
	// String new_id5 = ".,1.,2.,3.";
	// new_id5 = solution(new_id5);
	// new_id5.print();
	
	
	// String new_id = "abcdefghijklmn.p";
	// new_id = new_id.ToLower();													//lv1
	// new_id.print();
	
	// new_id = lv2(new_id);
	// new_id.print();	
	
	// new_id = lv3(new_id);														//lv3
	// new_id.print();
	
	// new_id = new_id.Trim('.');													//lv4
	// new_id.print();
	
	// new_id = lv5(new_id);														//lv5
	// new_id.print();
	
	// new_id = lv6(new_id);														//lv6
	// new_id.print();
	
	// new_id = lv7(new_id);														//lv7
	// new_id.print();
